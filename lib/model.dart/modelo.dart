...
import 'package:quiz2/views/viewproduct.dart';

class Product {
  final String articulo;
  final double calificaciones; // Updated to double
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      calificaciones: json['calificaciones'] != null
          ? double.parse(json['calificaciones'])
          : 0.0, // Parsing string to double
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ProductDetails(
          ...
          calificaciones: product.calificaciones.toString(), // Ensure calificaciones is passed as a string
